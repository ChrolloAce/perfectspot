        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600">
              ...
              website and use our mobile application, and tell you about your privacy rights.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              ...
              <li>Location Data: includes your current location when using the app</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600">
              ...
              <a href="mailto:privacy@perfectspot.app" className="text-blue-600 hover:text-blue-700">
                privacy@perfectspot.app
              </a>
            </p>
          </section>
        </div>
